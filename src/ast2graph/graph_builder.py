...
class GraphBuilder:
    ...
    def _visit(self, node: ast.AST, parent_id: str | None = None) -> str:
    ...
    def _extract_source_location(self, ast_node: ast.AST) -> tuple | None:
    ...
    def _extract_node_value(self, ast_node: ast.AST) -> str | None:
        ...
        if isinstance(ast_node, ast.FunctionDef | ast.AsyncFunctionDef | ast.ClassDef):
            ...
            return ast_node.name
        elif isinstance(ast_node, ast.arg | ast.keyword):
            return ast_node.arg
