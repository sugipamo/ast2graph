...
from typing import (
	Any,
	AnyStr,  # Replaced by `collections.abc.Collection` in 3.9.
...
def normalize_file(
	file: StrPath,
	separators: Collection[str] | None = None,
) -> str:
	"""
...
class TreeEntry:
	...
	def is_dir(self, follow_links: bool | None = None) -> bool:
		"""
	...
	def is_file(self, follow_links: bool | None = None) -> bool:
		"""
	...
	def stat(self, follow_links: bool | None = None) -> os.stat_result:
		"""
