...
class OpChecker(OpVisitor[None]):
    ...
    def visit_call(self, op: Call) -> None:
        ...
        for arg_value, arg_runtime in zip(op.args, op.fn.sig.args, strict=False):
    ...
    def visit_method_call(self, op: MethodCall) -> None:
        ...
        for arg_value, arg_runtime in zip(op.args, method_decl.sig.args[decl_index:], strict=False):
            self.check_type_coercion(op, arg_value.type, arg_runtime.type)
