...
class PowerShellLexer(RegexLexer):
    ...
    verbs = ['write', 'where', 'watch', 'wait', 'use', 'update', 'unregister', 'unpublish', 'unprotect', 'unlock', 'uninstall', 'undo', 'unblock', 'trace', 'test', 'tee', 'take', 'sync', 'switch', 'suspend', 'submit', 'stop', 'step', 'start', 'split', 'sort', 'skip', 'show', 'set', 'send', 'select', 'search', 'scroll', 'save', 'revoke', 'resume', 'restore', 'restart', 'resolve', 'resize', 'reset', 'request', 'repair', 'rename', 'remove', 'register', 'redo', 'receive', 'read', 'push', 'publish', 'protect', 'pop', 'ping', 'out', 'optimize', 'open', 'new', 'move', 'mount', 'merge', 'measure', 'lock', 'limit', 'join', 'invoke', 'install', 'initialize', 'import', 'hide', 'group', 'grant', 'get', 'format', 'foreach', 'find', 'export', 'expand', 'exit', 'enter', 'enable', 'edit', 'dismount', 'disconnect', 'disable', 'deny', 'debug', 'cxnew', 'copy', 'convertto', 'convertfrom', 'convert', 'connect', 'confirm', 'compress', 'complete', 'compare', 'close', 'clear', 'checkpoint', 'block', 'backup', 'assert', 'approve', 'aggregate', 'add']
    ...
    commenthelp = ['component', 'description', 'example', 'externalhelp', 'forwardhelpcategory', 'forwardhelptargetname', 'functionality', 'inputs', 'link', 'notes', 'outputs', 'parameter', 'remotehelprunspace', 'role', 'synopsis']
