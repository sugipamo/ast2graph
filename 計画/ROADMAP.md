...
### テスト修正タスク（緊急）
- [ ] **テストとコード実装の不整合修正** `[優先度: 緊急]`
  - [ ] models.pyのテスト修正（42個のテストが失敗中）
  - [ ] graph_structure.pyのテスト修正
  - [ ] graph_builder.pyのテスト修正
  - [ ] パラメータ名の統一（id vs node_id, properties vs metadataなど）
